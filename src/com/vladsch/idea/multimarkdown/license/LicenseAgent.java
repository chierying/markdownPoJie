...
public class LicenseAgent {
    ...
    public boolean getLicenseCode(LicenseRequest licenseRequest) {
        ...
        if (status.equals(STATUS_OK)) {
            ...
            if (LOG_AGENT_INFO)
                System.out.println("License server replied with status: " + status + ", message: " + message);
        }
    ...
    public boolean isValidActivation() {
        try {
            ...
            String activationJson = "{\"product_name\":\"idea-multimarkdown\",\"product_version\":\"1.8.4\",\"agent_signature\":\"475f99b03f6ec213729d7f5d577c80aa\",\"host_name\":\"cuitao-pcdemacbook-pro.local\",\"host_product\":\"WS-162.1121.31\",\"license_expires\":\"2026-08-03\",\"license_type\":\"license\",\"license_features\":1,\"feature_list\":{\"enhanced\":1,\"development\":2},\"activated_on\":\"2016-07-27\",\"activation_expires\":\"2026-08-03\"} ";
